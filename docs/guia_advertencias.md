...
| `hh_en_tarea_no_hoja` | Una tarea padre tiene HH Presupuestadas y sus subtareas no. | *Pendiente de definir* | — | — |
| `hh_distinta_de_time_estimate` | Las HH Presupuestadas de una tarea no coinciden con su time estimate. | *Pendiente de definir* | — | — |
