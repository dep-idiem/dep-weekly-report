...
| `horas_en_tarea_padre` | Hay horas registradas directamente en una tarea que tiene subtareas: no se sabe en qué subtarea se trabajó. En un paquete con porciones es Informativa: las horas cuentan bien en la fase y solo se pierde el detalle semanal. | Registra las horas en las subtareas de «<tarea>», no en la tarea padre. | JP | Distorsiona las cifras |
...
| `fase_con_hh` | Una fase (tarea de nivel 0) tiene HH Presupuestadas. Para el cálculo cuenta como paquete (entra a la línea base incremental cuando tiene fechas), pero las HH deben ir en un paquete dentro de la fase. | Mueve las HH de la fase «<tarea>» a un paquete con fechas dentro de ella y deja la fase sin HH. | JP | Distorsiona las cifras |
| `porcion_con_hh` | Una tarea con forma de porción semanal (misma tarea repetida por semana o persona) lleva HH Presupuestadas: el presupuesto debe estar en el paquete y la porción solo con time estimate. | Mueve las HH Presupuestadas de «<tarea>» a su paquete (la tarea padre) y deja la porción solo con time estimate. | JP | Distorsiona las cifras |
| `sin_presupuesto_contractual` | El proyecto no tiene presupuesto contractual: no se puede controlar el consumo de HH frente a lo contratado. | En la lista «<proyecto>», carga las HH contratadas en el campo HH Presupuestadas de la tarea «00 Administración». | JP | Impide el control de presupuesto |
| `presupuesto_por_agotarse` | El presupuesto contractual está superado o se agota en menos de 4 semanas al ritmo de las últimas 4. | Revisa con Administración DEP el plan de «<proyecto>»: el presupuesto se agota pronto. Si hay ampliación, actualiza las HH de «00 Administración». | JP | Informativa |
| `cumplimiento_semanal_fuera_de_rango` | Las horas registradas del proyecto quedaron bajo el 50 % o sobre el 150 % de lo planificado en las porciones en 3 de las últimas 4 semanas (medido por proyecto, nunca por persona). | Revisa con la planificadora el plan semanal de «<proyecto>»: ajusta los time estimates de las porciones a la carga real o registra las horas que faltan. | JP | Informativa |
| `paquete_desaparecido` | Un paquete congelado en la línea base ya no está en la lista (se borró o se movió). Sigue en la línea base. | Revisa con el JP de «<proyecto>» si el paquete se movió o se eliminó del alcance; si corresponde, congela una revisión de la línea base. | Administración DEP | Distorsiona las cifras |
